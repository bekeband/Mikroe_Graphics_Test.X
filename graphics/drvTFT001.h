...
*********************************************************************/
        ...
        #warning "This driver doesn't supports this resolution. Horizontal resolution must be 240 pixels."
    #endif
    #if (DISP_VER_RESOLUTION != 320)
        #warning "This driver doesn't supports this resolution. Vertical resolution must be 320 pixels."
    #endif
