...
#include "resids.h"       /* resource identifiers     */
#include "main.h"
...
/////////////////////////////////////////////////////////////////////////////
SCREEN_STATES   screenState = CREATE_BUTTONS;               // current state of main demo state machine
...
void CreateButtons(void)
{
  ...
  int ii = ((GetMaxY() - 258 + 1) / 2);
  int ij = ((40 + GetMaxX() - 177 + 1) / 2);
...
void InitializeBoard(void)
{
  ...
  GOLInit();
    ...
    SST25_CS_LAT = 1;
    SST25_CS_TRIS = 0;
      /* Initialize SST25 driver to SPI channels */
